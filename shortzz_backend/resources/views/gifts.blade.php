            ...
            <div class="modal-content" uib-modal-transclude="">
                ...
                <div class="modal-body clearfix">
                    ...
                    <form class="edit-detail-content" id='addUpdateGift' method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="animation_style">Animation Style</label>
                            <select class="form-control" id="animation_style" name="animation_style">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#gifts-listing").on("click", ".updateGift", function() {
                ...
                $('#animation_style').val($(this).attr('data-animation-style'));
                var validator = $("#addUpdateGift").validate();
                validator.resetForm();
            });
