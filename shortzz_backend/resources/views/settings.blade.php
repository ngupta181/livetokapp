                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form Autocomplete="off" class="form-group form-border" id="globalSettingsForm" action=""
                                ...
                                <div class="form-row ">
                                    <div class="form-group col-md-4">
                                        <label for="">Videos Between Ads</label>
                                        <input type="number" min="1" class="form-control" name="videos_between_ads"
                                            value="{{ $data->videos_between_ads }}" placeholder="Default: 5">
                                        <small class="form-text text-muted">Number of videos to show before displaying an interstitial ad</small>
                                    </div>
                                </div>
                                <div class="form-row ">
                                    <div class="form-group col-md-4">
